...
class UnitBase(OpsUnpacker):
    ...
    def unpack(self, packed):
        ...
        self._freeSlots = set(xrange(0, slotCount))
        memberCount, vehCount, playerCount, extrasLen, self._readyMask, self._flags, self._closedSlotMask, self._modalTimestamp = struct.unpack_from(self._HEADER, unpacking)
