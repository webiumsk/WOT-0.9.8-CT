...
class TOOLTIPS(object):
    GRAPHICSQUALITYHDSD = '#tooltips:graphicsQualityHDSD'
    ...
    GRAPHICSQUALITYHDSD_HEADER = GRAPHICSQUALITYHDSD + '/header'
    GRAPHICSQUALITYHDSD_BODY = GRAPHICSQUALITYHDSD + '/body'
