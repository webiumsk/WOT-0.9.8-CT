...
class _FlagsMarkerPlugin(IPlugin):
    ...
    def __addCaptureMarkers(self):
        ...
        for point in self.__capturePoints:
            if point['team'] == currentTeam:
                ...
                _, handle = self._parentObj.createStaticMarker(coordinates + self._parentObj.MARKER_POSITION_ADJUSTMENT, self.__CAPTURE_MARKER_TYPE)
    ...
    def __onSpawnedAtBase(self, flagID, flagPos):
        ...
        self.__addFlagMarker(flagID, flagPos, self.__FLAG_TYPE.NEUTRAL)
