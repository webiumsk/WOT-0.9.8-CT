...
class BoostersWindow(View, BoostersWindowMeta, AbstractWindowView, AppRef):
    ...
    def requestBoostersArray(self, isAvailableTab):
        self._isAvailableTab = isAvailableTab
        self.as_setListDataS(self.__getBoostersVOs(self._isAvailableTab), False)
        self.__setCommonData()

    def onBoosterActionBtnClick(self, boosterID, questID):
        if self._isAvailableTab:
    ...
    def _populate(self):
        ...
        self.as_setListDataS(self.__getBoostersVOs(self._isAvailableTab), True)
        self.__setCommonData()
    ...
    def __getBoostersVOs(self, isAvailableTab):
        boosterVOs = []
