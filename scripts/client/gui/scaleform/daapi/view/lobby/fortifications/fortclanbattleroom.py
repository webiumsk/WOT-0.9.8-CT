...
class FortClanBattleRoom(FortClanBattleRoomMeta, UnitListener, FortViewHelper):
    ...
    def __makeMainVO(self):
        ...
        if not canUseEquipments and unitPermissions.canChangeConsumables():
            result['ordersDisabledMessage'] = TextManager.getIcon(TextIcons.ALERT_ICON) + ' ' + TextManager.getText(TextType.ALERT_TEXT, i18n.makeString(FORTIFICATIONS.FORTCLANBATTLEROOM_HEADER_ORDERSDISABLED))
