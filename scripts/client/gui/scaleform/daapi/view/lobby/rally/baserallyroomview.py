...
class BaseRallyRoomView(BaseRallyRoomViewMeta, AppRef, UnitListener):
    ...
    def _updateVehiclesLabel(self, minVal, maxVal):
        vehicleLvl = self.textMgr.getText(TextType.MAIN_TEXT, i18n.makeString(CYBERSPORT.WINDOW_UNIT_RANGEVALUE, minVal=minVal, maxVal=maxVal))
        vehicleLbl = self.textMgr.getText(TextType.STANDARD_TEXT, i18n.makeString(CYBERSPORT.WINDOW_UNIT_TEAMVEHICLESLBL, levelsRange=vehicleLvl))
