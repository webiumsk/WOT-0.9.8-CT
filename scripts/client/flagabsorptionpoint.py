...
class FlagAbsorptionPoint(BigWorld.UserDataObject):
    _COLOR_WHITE = 4294967295L
    _DEFAULT_RADIUS_MODEL = 'content/Interface/CheckPoint/CheckPoint.visual'
    _OVER_TERRAIN_HEIGHT = 0.5

    def __init__(self):
        BigWorld.UserDataObject.__init__(self)
        print 'FlagAbsorptionPoint ', self.position, self.radius, self.team
    ...
    def __createTerrainSelectedArea(self, position, size):
        ...
        self.__terrainSelectedArea.setup(self._DEFAULT_RADIUS_MODEL, Vector2(size, size), self._OVER_TERRAIN_HEIGHT, self._COLOR_WHITE)
